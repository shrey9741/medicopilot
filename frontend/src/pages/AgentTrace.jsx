      ...
      <div style={{
        ...
        <div style={{ padding: '8px 10px', flex: 1, display: 'flex', flexDirection: 'column', gap: '2px' }}>
          {[
            ...
            { label: 'Agent Status', icon: 'smart_toy', path: '/agents', active: true },
          ].map((item) => (
            <div
              key={item.label}
        ...
        <div style={{ padding: '14px' }}>
          ...
          <div style={{ fontSize: '11px', color: '#9ca3af', marginBottom: '10px', paddingLeft: '4px', display: 'flex', flexDirection: 'column', gap: '6px' }}>
        ...
        <div style={{
          ...
          {['Active Cases', 'Alerts'].map((t, i) => (
            <div key={t} style={{
              ...
              borderBottom: i === 1 ? '2.5px solid #003178' : 'none',
              cursor: 'pointer',
            }}>{t}</div>
          ))}
        ...
        <div style={{ padding: '24px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px' }}>
            <div>
              ...
              <p style={{ fontSize: '13px', color: '#9ca3af', marginTop: '4px', maxWidth: '480px' }}>
                Real-time visualization of clinical data ingestion, specialized agent synthesis, and final briefing generation.
              </p>
            </div>
            <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
              ...
              <div style={{ padding: '6px 12px', background: '#fff', borderRadius: '8px', fontSize: '11px', fontWeight: 700, color: '#9ca3af', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
                LATENCY: 42MS
              </div>
            </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '200px 1fr 200px', gap: '14px', marginBottom: '14px' }}>
            ...
            <div style={{ background: '#fff', borderRadius: '12px', padding: '14px', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
              ...
              {NOTES.map((note, i) => (
                <div key={i} style={{
                  background: '#f8f9fb', borderRadius: '6px', padding: '10px',
                  marginBottom: i < 2 ? '8px' : 0,
                  fontSize: '11px', color: '#5a5e6b', lineHeight: 1.5,
                  fontStyle: 'italic', borderLeft: '3px solid #e1e2e4',
                }}>
                  {note}
                </div>
              ))}
            ...
            <div style={{ background: '#fff', borderRadius: '12px', padding: '14px', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
                ...
                {AGENTS.map((agent) => (
                  <div key={agent.name} style={{ background: '#f8f9fb', borderRadius: '8px', padding: '12px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                      ...
                      <span style={{ fontSize: '9px', fontWeight: 700, padding: '2px 7px', borderRadius: '10px', background: agent.statusBg, color: agent.statusColor }}>
                        {agent.status}
                      </span>
                    </div>
              ...
              {/* Longitudinal Analyst — full width */}
              <div style={{ background: '#f8f9fb', borderRadius: '8px', padding: '12px' }}>
                ...
                <div style={{ fontSize: '11px', color: '#5a5e6b' }}>
                  Correlating 5 years of outpatient visits with current acute presentation.
                </div>
              </div>
            </div>
            ...
            <div style={{ background: 'linear-gradient(160deg,#001d4a,#003178)', borderRadius: '12px', padding: '16px', color: '#fff' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '16px' }}>
                {[
                  'High confidence ACS diagnosis (94%).',
                  'Immediate Cardiac consult recommended.',
                  'Medication adjustments prepared for review.',
                ].map((item, i) => (
              ...
              <button
                onClick={() => navigate('/patient/P001')}
                style={{ width: '100%', padding: '10px', background: 'rgba(255,255,255,0.15)', border: '1px solid rgba(255,255,255,0.2)', borderRadius: '8px', color: '#fff', fontSize: '12px', fontWeight: 700, cursor: 'pointer' }}
              >
                View Full Report
              </button>
            </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '12px', marginBottom: '20px' }}>
            {STATS.map((s) => (
              <div key={s.label} style={{ background: '#fff', borderRadius: '10px', padding: '14px 16px', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
                ...
                {s.bar && (
                  <div style={{ height: '4px', background: '#f2f4f6', borderRadius: '2px', marginBottom: '4px' }}>
                    <div style={{ height: '4px', width: '98%', background: '#1a7a45', borderRadius: '2px' }} />
                  </div>
                )}
          ...
          {/* Hackathon Tech Spotlight */}
          <div style={{
            background: '#fff', borderRadius: '12px', padding: '32px',
            boxShadow: '0 1px 4px rgba(0,0,0,0.06)',
            display: 'grid', gridTemplateColumns: '280px 1fr', gap: '32px', alignItems: 'center',
          }}>
            <img
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuBVhL4sqFbqSYnTOJH9AeecV131gQNw4Z7BSE-mbTGdmZExqAkgo7xB-Og_KS2Umg9e_Effx8jNSD2WTSZLr8qFUjtaPAGlu7N1w6U-joyPqFxxs4bzFNyYzn1SO0ZmnJRqYicHj-ulKfo2rF8QrTvNz1Sm1TdVSHVo99mExzC9q5CNques4SIFUN5P8dX2XXJiBo-Yx0eIJxznkXRPcK7yFyo9YMfsvTa-9FMzD5Pa_8Fmu_lsTibSVpXwTc4YLZXhNZnd-CVrTEw"
              alt="Hyper-Specialized AI"
            ...
            <div>
              <div style={{
                ...
                color: '#003178', background: 'rgba(0,49,120,0.07)',
                padding: '4px 12px', borderRadius: '20px', marginBottom: '16px',
              }}>
                Hackathon Tech Spotlight
              </div>
              <h2 style={{ fontFamily: 'Manrope,sans-serif', fontWeight: 800, fontSize: '28px', color: '#003178', lineHeight: 1.15, marginBottom: '16px' }}>
                Hyper-Specialized Micro-Agents
              </h2>
              <p style={{ fontSize: '14px', color: '#5a5e6b', lineHeight: 1.7, marginBottom: '24px' }}>
                Instead of one generic LLM, Clinical Sentinel orchestrates 9 specialized agents. Each agent is tuned for a specific medical domain — from pharmacokinetics to billing compliance — ensuring precision that "one-size-fits-all" AI simply cannot match.
              </p>
