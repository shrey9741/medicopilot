...
function mapPatient(p, index) {
  const times = ['08:15', '09:00', '09:30', '10:15', '11:00', '11:30'];
  const statuses = ['briefing', 'anomaly', 'briefing', 'waiting', 'briefing', 'pending'];
  ...
  return {
    id: p.id || p.patient_id || `P00${index + 1}`,
    ...
    <div style={{ display: 'flex', minHeight: '100vh', fontFamily: 'Inter,sans-serif', background: '#f8f9fb' }}>
      ...
      <div style={{
        ...
        <div style={{ padding: '24px 20px 16px' }}>
          ...
          <div style={{ fontSize: '9px', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#9ca3af', marginTop: '2px' }}>Precision Medicine</div>
        </div>
        ...
        <div style={{ padding: '14px' }}>
          ...
          <div onClick={handleLogout} style={{ fontSize: '11px', color: '#9ca3af', cursor: 'pointer', textAlign: 'center', marginTop: '8px' }}>
            Sign out
          </div>
        </div>
      </div>
      ...
      <div style={{ marginLeft: '220px', flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{
          ...
          <div style={{ flex: 1, position: 'relative', maxWidth: '280px', marginLeft: 'auto' }}>
            ...
            <input placeholder="Search electronic health records..." style={{ width: '100%', padding: '7px 12px 7px 34px', background: '#f2f4f6', border: 'none', borderRadius: '8px', fontSize: '12px', fontFamily: 'Inter,sans-serif', color: '#191c1e', outline: 'none' }} />
          </div>
          <button style={{ padding: '7px 14px', background: '#ba1a1a', color: '#fff', border: 'none', borderRadius: '8px', fontSize: '11px', fontWeight: 700, cursor: 'pointer', whiteSpace: 'nowrap', display: 'flex', alignItems: 'center', gap: '5px' }}>
                ...
                patients.map((p, i) => (
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                      ...
                      {p.status2 && (
                        <span style={{ padding: '4px 10px', borderRadius: '5px', fontSize: '11px', fontWeight: 600, width: 'fit-content', ...STATUS_STYLES[p.status2] }}>{p.status2Label}</span>
                      )}
                    </div>
